...
export function SellForm() {
  ...
  return (
    ...
    >
      <CardHeader>
        <CardTitle>Sell your product with ease |
        商品を出品
        </CardTitle>
        <CardDescription>
          Please describe your product here in detail so that it can be sold <br/>
          商品の詳細、特徴、セールスポイントを入力してください。より多くの情報があれば、最適な購入者との出会いにつながります。
        </CardDescription>
      </CardHeader>
